...
namespace SpatialPartitionPattern
{
    public class GameController : MonoBehaviour
    {
        ...
        List<Soldier> neutralSoldiers = new List<Soldier>();
        ...
        void Start()
        {
            ...
            for (int i = 0; i < numberOfSoldiers; i++)
            {
                ...
                enemySoldiers.Add(new Enemy(newEnemy, mapWidth, enemyGrid));
                ...
                //Give the neutral a random position
                randomPos = new Vector3(Random.Range(0f, mapWidth), 0.5f, Random.Range(0f, mapWidth));

                //Create a new neutral
                GameObject newNeutral = Instantiate(neutralObj, randomPos, Quaternion.identity) as GameObject;

                //Add the friendly to a list
                neutralSoldiers.Add(new Neutral(newNeutral, mapWidth));

                //Parent it 
                newNeutral.transform.parent = neutralParent;
            }
        }
        ...
        void Update()
        {
            ...
            for (int i = 0; i < neutralSoldiers.Count; i++)
            {
                neutralSoldiers[i].Move();
            }
